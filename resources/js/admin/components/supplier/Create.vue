			...
			<div class="row">
					<div class="col">
							<div class="breadcrumb">
								...
								<span class="breadcrumb-item active">{{ trans('text.add-supplier')}}</span>
							</div>
					</div>
	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<section v-else class="content">
				<div class="row">
					<div class="col-xl-12">
						<supplier-form :action="'create'" :supplier="supplier"></supplier-form>
					</div>
				</div>
			</section>
		</div>
...
export default {
	...
	methods: {
		ceatesupplier() {
			...
			axios.get('/api/suppliers/create')
