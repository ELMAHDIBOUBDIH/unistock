			...
			<div class="row">
					<div class="col">
							<div class="breadcrumb">
								...
								<span class="breadcrumb-item active">{{ trans('text.edit-purchase')}}</span>
							</div>
					</div>
					...
					<div class="col">
							<div class="header-elements align-items-center">
								<router-link to="/admin/purchases/create">
									<button class="btn bg-teal-400 btn-icon btn-sm">{{ trans('text.add-purchase')}}</button>
								</router-link>
							</div>
					</div>
			</div>
			...
			<section v-else class="content">
				<div class="row">
					<div class="col-xl-8 mx-auto">
						<purchase-form :action="'edit'" :purchase="purchase" :suppliers="suppliers"></purchase-form>
					</div>
				</div>
			</section>
		</div>
...
export default {
	...
	methods: {
		editPurchase() {
			var self = this;
			axios.get('/api/purchases/'+ self.$route.params.id+'/edit')
