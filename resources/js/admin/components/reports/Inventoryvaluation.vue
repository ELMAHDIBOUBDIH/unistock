			...
			<div class="row">
				<div class="col">
					<div class="breadcrumb">
						...
						<span class="breadcrumb-item active">{{ trans('text.inventoryvaluation-report')}}</span>
					</div>
				</div>
                <div class="col">
					<div class="page-title">
						<h5>{{ trans('text.inventoryvaluation-report')}}</h5>
					</div>
				</div>
				<div class="col">
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header">
								<i class="icon-cube3"></i> {{ trans('text.inventory-valuation')}}
							</div>
...
export default {
	data() {
		return {
            ...
            url_base: '/api/reports/inventoryvaluation?',
            report_items: {},
		};
	},
	methods: {
        ...
        filter(string){
            this.url_base = '/api/reports/inventoryvaluation' + string;
            this.getReport();
        },
	},
	mounted() {
