			...
			<div class="row">
				<div class="col">
					<div class="breadcrumb">
						...
						<span class="breadcrumb-item active">{{ trans('text.paymentmade-report')}}</span>
					</div>
				</div>
                <div class="col">
					<div class="page-title">
						<h5>{{ trans('text.paymentmade-report')}}</h5>
					</div>
				</div>
				<div class="col">
...
export default {
	data() {
		return {
            ...
            url_base: '/api/reports/paymentmade?',
            report_items: {},
		};
	},
	methods: {
        ...
        filter(string){
            this.url_base = '/api/reports/paymentmade' + string;
            this.getReport();
        },
	},
	mounted() {
