			...
			<div class="row">
				<div class="col">
					<div class="breadcrumb">
						...
						<span class="breadcrumb-item active">{{ trans('text.receive-report')}}</span>
					</div>
				</div>
                <div class="col">
					<div class="page-title">
						<h5>{{ trans('text.receive-report')}}</h5>
					</div>
				</div>
				<div class="col">
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header">
								<i class="icon-cube3"></i> {{ trans('text.receives')}}
							</div>
...
export default {
	...
	methods: {
        ...
        filter(string){
            this.url_base = '/api/reports/receive' + string;
            this.getReport();
        },
	},
	mounted() {
